return {
  ...
  config = function()
    ...
    -- C / Rust (shared adapter — server mode supports both)
    ...
    -- POWERSHELL
    dap.adapters.powershell = Project_dap and Project_dap.dap.adapters.powershell
      or {
        type = "executable",
        command = vim.fn.stdpath "data" .. "/mason/packages/powershell-editor-services/PowerShellEditorServices/",
        name = "PowerShell",
      }

    dap.configurations.powershell = Project_dap and Project_dap.dap.configurations.powershell
      or {
        {
          name = "launch",
          type = "PowerShell",
          request = "launch",
          script = function()
            return vim.fn.getcwd() .. "/script.ps1"
          end,
          args = {},
        },
      }
