...
local mappings = {
  ...
  { "<leader>fs", "<cmd>lua require('spectre').toggle()<cr>", desc = "spectre" },
  ...
  { "<leader>le", "<cmd>TinyInlineDiag toggle<cr>", desc = "diagnostic" },
  ...
  { "<leader>ll", "<cmd>lua require('chainsaw').variableLog()<cr>", desc = "variable log" },
  {
    "<leader>lq",
  ...
  { "<leader>e", "<cmd>Fyler<cr>", desc = "explorer" },

  --misc
  { "<leader>q", group = "misc" },
  { "<leader>qb", "<cmd>:g/^$/d<cr>:noh<cr>", desc = "remove blanklines" },
  { "<leader>qi", "<cmd>Nerdy<cr>", desc = "icons" },
  ...
  { "<leader>qc", group = "curlo" },
  { "<leader>qco", "<cmd>CurloHistory<cr>", desc = "history" },
  { "<leader>qcc", "<cmd>CurloRun<cr>", desc = "run" },
  { "<leader>qr", group = "kulala" },
  { "<leader>qro", "<cmd>lua require('kulala').open()<cr>", desc = "open" },
  { "<leader>qrr", "<cmd>lua require('kulala').run()<cr>", desc = "run" },
